...
{
    public partial class CreatePQ : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            {
                Purchase.PurchaseQuotation.DetailPQ DetailPQ = new Purchase.PurchaseQuotation.DetailPQ();

                List<Purchase.PurchaseQuotation.DetailPQ> ListDetailPQ = new List<Purchase.PurchaseQuotation.DetailPQ>();
        ...
        public void CreateNew(string RfqNumber)
        {
            txtPrNumber.Text = RfqNumber;      
            ...
            Query = "Select GroupId, SubGroup1Id, SubGroup2Id, ItemId, [FullItemID], ItemDeskripsi, [Qty], [Unit], Deskripsi,PurchReqID,PurchReqSeqNo, b.VendId, b.VendName From [RequestForQuotationD] a inner join RequestForQuotationH b on a.RfqId=b.RfqId Where a.RfqId = '" + txtPrNumber.Text + "' order by RfqSeqNo asc";
            ...
            while (Dr.Read())
            {
                this.dgvPqDetails.Rows.Add(dgvPqDetails.Rows.Count + 1, Dr[0], Dr[1], Dr[2], Dr[3], Dr[4], Dr[5], Dr[6], Dr[7], "", "", "", "", "", Dr[9], Dr[10], "", Dr[8], "", "", "", "", "", "", "");

                txtVendorId.Text = Dr[11].ToString();
                txtVendorName.Text = Dr[12].ToString();
        ...
        private void CreatePQ_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void CreatePQ_Shown(object sender, EventArgs e)
        {
        ...
        {
            string SchemaName = "dbo";
            string TableName = "RequestForQuotationH";
            ...
            Query = "Select GroupId, SubGroup1Id, SubGroup2Id, ItemId, [FullItemID], ItemDeskripsi, [Qty], [Unit], Deskripsi,PurchReqID,PurchReqSeqNo From [RequestForQuotationD] a inner join RequestForQuotationH b on a.RfqId=b.RfqId Where a.RfqId = '" + txtPrNumber.Text + "' order by RfqSeqNo asc";
        ...
        private void txtPPH_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtPPH.Text != "")
            {
                for (int i = 0; i < dgvPqDetails.RowCount; i++)
                {
                    if(dgvPqDetails.Rows[i].Cells["SubTotal"].Value == "")
                        dgvPqDetails.Rows[i].Cells["SubTotal"].Value = "0";
        ...
        private void dgvPqDetails_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvPqDetails.Columns[e.ColumnIndex].Name.ToString() == "FullItemID")
            {
                Purchase.PurchaseRequisition.Info tmpInfo = new Purchase.PurchaseRequisition.Info();
            ...
            if (dgvPqDetails.Columns[e.ColumnIndex].Name.ToString() == "ItemName")
            {
                Purchase.PurchaseRequisition.Info tmpInfo = new Purchase.PurchaseRequisition.Info();
