...
namespace ISBS_New.Purchase.NotaPurchaseParked
{
    public partial class DetailParkedItem : MetroFramework.Forms.MetroForm
    {
        ...
        Purchase.NotaPurchaseParked.HeaderNotaPurchaseParked Parent;
        ...
        public void ParentRefreshGrid(Purchase.NotaPurchaseParked.HeaderNotaPurchaseParked F)
        {
            Parent = F;
        }
        ...
        private void RefreshDataGrid()
        {
            ...
            Query = "SELECT '' AS No, GoodsReceivedSeqNo AS SeqNo, a.FullItemId, a.ItemName, a.Qty_Actual AS Qty, a.Unit, a.Ratio FROM GoodsReceivedD a WHERE a.GoodsReceivedId = '" + GoodsReceivedId + "' AND a.ActionCodeStatus = '02' ";
            ...
            {
                Query += "UNION ";
                Query += "SELECT '' AS No, b.SeqNo, b.FullItemId, b.ItemName, b.Qty, b.Unit, (SELECT Ratio FROM GoodsReceivedD ";
                Query += "WHERE GoodsReceivedId = (SELECT GoodsReceivedId FROM NotaPurchaseParkH WHERE NPPID = '"+NotaNumber+"') AND GoodsReceivedSeqNo = b.SeqNo) AS Ration ";
           ...
           // int k = 1;
            ...
            dgvParkedItemDetails.Columns["Ratio"].ReadOnly = true;
        ...
        private void MethodSelectData()
        {
            ...
            for (int i = 0; i <= dgvParkedItemDetails.RowCount - 1; i++)
            {
                ...
                if (Check == true)
                {
                    ...
                    Ratio.Add(dgvParkedItemDetails.Rows[i].Cells["Ratio"].Value.ToString());
                }
            }

            Parent.AddDataGridDetail(FullItemId, ItemName, Qty, Unit, SeqNo, Ratio);
