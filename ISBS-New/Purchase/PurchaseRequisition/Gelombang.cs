...
namespace ISBS_New.Purchase.PurchaseRequisition
{
    public partial class Gelombang : MetroFramework.Forms.MetroForm
    {
        ...
        public void SetParentForm(Purchase.PurchaseRequisition.HeaderPR F)
        {
            Parent = F;
        }      
        ...
        private void RefreshGrid()
        {
            ...
            Query += "From dbo.[InventGelombangD] a Left Join dbo.[InventTable] b on a.[ItemId]=b.FullItemId left join dbo.InventGelombangH c on a.GelombangId=c.GelombangId AND c.Type='Purchase' and a.BracketId=c.BracketId ";
            Query += "Where a.Type='Purchase' and c.Type='Purchase' and a.GelombangId='" + Gelombang1 + "' and a.BracketId='" + Bracket + "' order by GelombangId asc, BracketId asc, Base desc ";
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            Parent.AddDataGridGelombang(GroupId, SubGroup1Id, SubGroup2Id, ItemId, FullItemId, ItemName, GelombangId, BracketId, Base, Price, VendId, BracketDesc);
            this.Close();
        }
