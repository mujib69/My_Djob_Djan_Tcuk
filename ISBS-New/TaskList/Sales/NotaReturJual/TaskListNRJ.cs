...
namespace ISBS_New.TaskList.Sales.NotaReturJual
{
    public partial class TaskListNRJ : MetroFramework.Forms.MetroForm
    {
        ...
        private void TaskListNRJ_Load(object sender, EventArgs e)
        {
            addCmbCriteria();
            ModeLoad();
        }
        ...
        {
            ISBS_New.Sales.NotaReturJual.NRJApproval f = new ISBS_New.Sales.NotaReturJual.NRJApproval();
