...
{
    public partial class InquiryCustomerInvoice : MetroFramework.Forms.MetroForm
    {
        ...
        private void InquiryCustomerInvoice_Load(object sender, EventArgs e)
        {
            addCmbStatusCode();
            addCmbCrit();
            ModeLoad();
        ...
        private void InquiryCustomerInvoice_Shown(object sender, EventArgs e)
        {
        ...
        private void addCmbCrit()
        {
            ...
            Conn = ConnectionString.GetConnection();
            Query = "Select DisplayName From [User].[Table] Where SchemaName = 'dbo' And TableName = 'CustInvoiceH' ORDER BY OrderNo ASC";
            Cmd = new SqlCommand(Query, Conn);
            Dr = Cmd.ExecuteReader();
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            if (this.PermissionAccess(ControlMgr.New) > 0)
            {
                ...
                {
                    HeaderCustomerInvoice H = new HeaderCustomerInvoice();
                    H.SetMode("New", "");
                    H.SetParent(this);
                    H.Show();
                }
        ...
        public void RefreshGrid()
        {
            ...
            {
                TransStatus = "'01', '02', '07', '08', '11', '17'"; Limit1 = 1; Limit2 = dataShow;
            }
            ...
            Query = "SELECT COUNT(a.Invoice_Id) FROM CustInvoice_H a Inner join TransStatusTable b on b.StatusCode = a.TransStatus and b.TransCode='CustInvoice' and a.TransStatus IN (" + TransStatus + ") ";
        ...
        {
            HeaderCustomerInvoice header = new HeaderCustomerInvoice();
        ...
        {
            TransStatus = "'03', '05', '09', '13', '20', '21', '22'";           
        ...
        private void dgvCustomerInvoice_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            SelectData();
        }
