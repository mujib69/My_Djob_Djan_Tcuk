...
{
    public partial class LookupVendorReference : MetroFramework.Forms.MetroForm
    {
        ...
        public LookupVendorReference()
        {
            InitializeComponent();
        }

        private void LookupVendorReference_Load(object sender, EventArgs e)
        {
        ...
        private void LookupVendorReference_Shown(object sender, EventArgs e)
        {
