...
{
    public partial class GroupDashboard : Form
    {
        //SQL Function
                ...
                using (SqlCommand Command = new SqlCommand(Query, Conn))
                {
                    ...
                    while (Dr.Read())
                    {
                        ...
                        if (tmpAmbilKodeNo == false)
                            if (i == 0)
                                cmbCriteria.Text = "All";//Dr[0].ToString();
                        i += 1;
                    }
                }
            }
        ...
        private void SelectData()
        {
            try
            {
                if (dgvSearch.RowCount >= 1)
                {
                    ...
                    Master.User.Group.GroupForm F = new Master.User.Group.GroupForm();
                    F.Show();
        ...
        private void GroupDashboard_FormClosed(object sender, FormClosedEventArgs e)
        {
            timerRefresh.Stop();
        }
