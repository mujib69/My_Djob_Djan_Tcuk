...
{
    public partial class UserIdDashboard : Form
    {
        //SQL Function
        ...
        private void SelectData()
        {
            try
            {
                if (dgvSearch.RowCount >= 1)
                {
                    ...
                    Master.User.UserId.UserIdForm F = new Master.User.UserId.UserIdForm();
                    F.Show();
        ...
        private void UserIdDashboard_FormClosed(object sender, FormClosedEventArgs e)
        {
            timerRefresh.Stop();
        }
