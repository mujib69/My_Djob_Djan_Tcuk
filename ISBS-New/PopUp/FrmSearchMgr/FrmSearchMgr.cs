...
{
    public partial class FrmSearchMgr : MetroFramework.Forms.MetroForm
    {
        ...
        private void FrmSearchMgr_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ConTrans = ConnectionString.GetConnection();
        ...
        private void FrmSearchMgr_FormClosed(object sender, FormClosedEventArgs e)
        {
            Ds.Clear();
            ConTrans.Close();
            GC.Collect();
